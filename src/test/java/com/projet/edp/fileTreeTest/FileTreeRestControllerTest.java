...
class FileTreeRestControllerTest {
	...
	void GivenEmptyDirectoryId1_whenHTTPRequestGETTreeItemId1_thenGetStoredDirectoryIdEquals1() throws Exception {
		...
		.andExpect(content().string(containsString("{\"item_id\":\"1\",\"name\":\"home\",\"item_local_path\":\"/home/\",\"item_type\":\"folder\",\"children\":[]}")));
	}
	...
	void GivenDirectoryId1ContainsDirectoryId2_whenRequestGETTreeItemId1_thenGetDirectoryId1ContainsDirectoryId2() throws Exception {
		...
		this.mockMvc.perform(get("/api/file-tree?item_id=1")).andDo(print())
		.andExpect(status().isOk())
		.andExpect(content().string(containsString("{\"item_id\":\"1\",\"name\":\"home\",\"item_local_path\":\"/home/\",\"item_type\":\"folder\",\"children\":[{\"item_id\":\"2\",\"name\":\"Henri Salvador\",\"item_local_path\":\"/home/henri_salvador\",\"item_type\":\"folder\",\"children\":[]}]}")))
		;
	}
	...
	void GivenDirectoryId1ContainsDirectoryId2ContainsFileId3_whenRequestGETTreeItemId1_thenGetDirectoryId1ContainsDirectoryId2ContainsFileId3() throws Exception {
		...
		.andExpect(content().string(containsString(
				  "{\"item_id\":\"1\",\"name\":\"home\",\"item_local_path\":\"/home/\",\"item_type\":\"folder\",\"children\":[{\"item_id\":\"2\",\"name\":\"Henri Salvador\",\"item_local_path\":\"/home/henri_salvador\",\"item_type\":\"folder\",\"children\":[{\"item_id\":\"3\",\"name\":\"Dans mon ile\",\"item_local_path\":\"/home/henri_salvador/dans_mon_ile.pdf\",\"item_type\":\"file\",\"children\":[]}]}]}")));
	}
