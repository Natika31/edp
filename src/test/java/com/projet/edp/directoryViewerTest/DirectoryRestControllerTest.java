...
class DirectoryRestControllerTest {
	...
	void GivenSelectedDirectory_whenRequestGETEmptyDirectoryIdEquals1_thenGetStoredDirectoryIdEquals1() throws Exception {
		Directory emptyDirectory = new Directory("/home/", "home");
		...
		.andExpect(content().string(containsString("directory_id\":\"1\",\"directory_local_path\":\"/home/\",\"directory_name\":\"home\",\"childrenDTO\":[]")))
		;
	}
	...
	void GivenSelectedDirectory_whenRequestGETNonEmptyDirectoryIdEquals2_thenGetStoredDirectoryIdEquals2AndGetItsContent() throws Exception {
		...
		.andExpect(content().string(containsString("directory_id\":\"2\",\"directory_local_path\":\"/home/\",\"directory_name\":\"home\",\"childrenDTO\":[{\"file_id\":\"1\",\"file_name\":\"Dans mon ̨le\",\"binary_content\":\"JVBERi0xLjcKCjQgMCBvYmoKKElkZW50aXR5KQplbmRvYmoKNSAwIG9iagooQWRvYmUpC")))
		;
	}
}
