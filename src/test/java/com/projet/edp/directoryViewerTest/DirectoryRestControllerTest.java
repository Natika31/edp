...
class DirectoryRestControllerTest {
	...
	void GivenSelectedDirectory_whenRequestGETNonEmptyDirectoryIdEquals2_thenGetStoredDirectoryIdEquals2AndGetItsContent() throws Exception {
		...
		.andExpect(content().string(containsString("directory_id\":2,\"directory_local_path\":\"/home/\",\"directory_name\":\"Henri Salvador\",\"children\":[{\"file_id\":\"1\",\"file_name\":\"Dans mon ̨le\",\"binary_content\":\"JVBERi0xLjcKCjQgMCBvYmoKKElkZW50aXR5KQplbmRvYmoKNSAwIG9iagooQWRvYmUpC")))
		;
	}
}
