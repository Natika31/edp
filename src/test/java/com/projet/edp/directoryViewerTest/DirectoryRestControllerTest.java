...
class DirectoryRestControllerTest {
	...
	void GivenSelectedDirectory_whenRequestGETEmptyDirectoryIdEquals1_thenGetStoredDirectoryIdEquals1() throws Exception {
		...
		.andExpect(content().string(containsString("{\"item_id\":\"1\",\"name\":\"home\",\"item_local_path\":\"/home/\",\"children\":[]}")))
		;
	}
	...
	void GivenSelectedDirectory_whenRequestGETNonEmptyDirectoryIdEquals2_thenGetStoredDirectoryIdEquals2AndGetItsContent() throws Exception {
		...
		nonEmptyDirectory.setItem_id(2L);
		...
		.andExpect(content().string(containsString("{\"item_id\":\"2\",\"name\":\"home\",\"item_local_path\":\"/home/\",\"children\":[{\"item_id\":\"1\",\"name\":\"/home/\",\"item_local_path\":\"Dans mon ̨le\",\"item_type\":\"class com.projet.edp.fileTree.domain.MyFile\",\"children\":[]}]}")))
		;
	}
}
